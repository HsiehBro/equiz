import { AtRule, ChildNode, Declaration, Input, Root, Rule } from "postcss";
 ...
 */
type DeepPartial<T> = { [K in keyof T]?: T[K] extends any[] ? T[K] : T[K] extends Record<string, any> ? DeepPartial<T[K]> : T[K] };
/**
 ...
 */
declare function createExcludeMatcher(exclude: readonly (string | RegExp)[] | ((filePath: string) => boolean)): (filepath: string | undefined) => boolean;
//#endregion
export { DeepPartial, ReplaceContext, SelectorBlacklistMatcherOptions, UnitRegexOptions, WalkAndReplaceOptions, blacklistedSelector, createAdvancedPropListMatcher, createConfigGetter, createExcludeMatcher, createPropListMatcher, createSelectorBlacklistMatcher, createUnitRegex, declarationExists, maybeBlacklistedSelector, mergeOptions, pxRegex, remRegex, toFixed, walkAndReplaceValues };