...
type ResetPreset = 'minimal' | 'form' | 'content' | 'media' | 'all';
type BuiltInResetName = 'buttonReset' | 'imageReset' | 'inputReset' | 'textareaReset' | 'listReset' | 'navigatorReset' | 'videoReset';
...
declare const reset: ResetPlugin;
//#endregion
export { type BuiltInResetName, type ResetConfig, type ResetOptions, ResetPlugin, ResetPluginResult, type ResetPreset, reset as default, reset };