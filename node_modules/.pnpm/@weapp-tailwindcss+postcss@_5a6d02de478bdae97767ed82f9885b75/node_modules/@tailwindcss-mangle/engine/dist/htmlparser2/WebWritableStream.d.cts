import { r as ParserOptions, t as Handler } from "../Parser-DxhIcQSO.cjs";
//#region ../../node_modules/.pnpm/htmlparser2@12.0.0/node_modules/htmlparser2/dist/WebWritableStream.d.ts
/**
 ...
 * ```
 */
declare class WebWritableStream extends WritableStream<string | Uint8Array> {
  constructor(cbs: Partial<Handler>, options?: ParserOptions);
}
//#endregion
export { WebWritableStream };