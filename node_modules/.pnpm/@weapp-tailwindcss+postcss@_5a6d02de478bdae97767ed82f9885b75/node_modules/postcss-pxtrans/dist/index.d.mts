import { Comment, Input, Result, Root } from "postcss";
 ...
 */
type PxTransformMethod = 'platform' | 'size';
/**
 ...
 */
type PxTransformPlatform = 'weapp' | 'h5' | 'rn' | 'quickapp' | 'harmony';
/**
 ...
 */
type PxTransformTargetUnit = 'rpx' | 'rem' | 'px' | 'vw' | 'vmin';
/**
 ...
 */
type DesignWidth = number | ((input: Input) => number);
/**
 ...
 */
interface PxTransformDeviceRatio {
 ...
 */
declare function createDirectivePlugin(options?: PxTransformOptions): {
 ...
 */
declare function plugin(userOptions?: PxTransformOptions): {
  postcssPlugin: string;
  prepare?: never;
} | {
  postcssPlugin: string;
...
//#endregion
export { DesignWidth, PxTransformDeviceRatio, PxTransformMethod, PxTransformOptions, PxTransformPlatform, PxTransformTargetUnit, createDirectivePlugin, plugin as default };